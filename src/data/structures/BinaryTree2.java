...
public class BinaryTree2 {
	...
	public static TreeNode2 inOrderSuccessor(TreeNode2 e) {
		if (e != null) {
			TreeNode2 p;
	...
	private boolean covers(TreeNode2 root, TreeNode2 p) { /* is p a child of root? */
		if (root == null)
			return false;
		if (root == p)
			return true;
	...
	public static void main(String[] args) {
		...
		TreeNode2 p = lists.get(3).get(2);
		TreeNode2 q = lists.get(3).get(3);
		
		TreeNode2 ca = tree.commonAncestor(tree.root, p, q);
		System.out.println("Common ancestor of:  " + p.data + " and " + q.data + " is " + (ca != null ? ca.data : "null"));
		
		TreeNode2 succ = BinaryTree2.IOS(q);
		System.out.println("Successor of:  " + q.data + " is " + (succ != null ? succ.data : "null"));
