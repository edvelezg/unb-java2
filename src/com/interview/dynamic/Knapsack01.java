 ...
 *         maximum allowed weight how to pick items to pick items from this set
 *         to maximize sum of value of items such that sum of weights is less
 *         than or equal to maximum allowed weight.
 *
 *         Time complexity - O(W*total items)
 *
 *         Youtube link Topdown DP - https://youtu.be/149WSzQ4E1g Bottomup DP -
...
public class Knapsack01 {
    ...
    public static void main(String args[]) {
        ...
        int r1 = k.topDownRecursive(val, wt, 7);
